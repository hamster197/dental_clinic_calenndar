...
(function($) {
    ...
    $.fn.captcha = function(param) {
        ...
        $('<div class="form-floating form-floating-outline lr-margin"><label id="' + params.idCaptchaText + '"></label><input class="form-control lr-input lr-width-1-6 lr-margin-small-left" id="' + params.idCaptchaInput + '" aria-label="Captcha Input" type="text" required></div>').insertBefore(submit);
        ...
        $(label).text(' Решите пример: ' + rndmNr1 + ' + ' + rndmNr2 + ' =');
